...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "$BUILT_PRODUCTS_DIR/JIRAMobileConnect/JIRAMobileConnect.framework"
  ...
  install_framework "$BUILT_PRODUCTS_DIR/TrashCanKit/TrashCanKit.framework"
fi
